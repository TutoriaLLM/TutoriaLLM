...
export default function Stats(props: { session: SessionValue }) {
	const { session } = props;
	return (
		<div className="bg-gray-200 rounded-2xl p-2 gap-2 w-full">
			<h2 className="text-lg font-semibold">Stats</h2>
			<h3 className="font-medium text-md text-gray-600 flex gap-1">
				<Bot />
				Total Invoked LLM:
			...
			<h3 className="font-medium text-md text-gray-600 flex gap-1 flex-nowrap">
				<Clock />
